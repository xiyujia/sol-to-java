...
contract StandardToken is BasicToken,ERC20 {
    function StandardToken(string _name,string _symbol,uint8 _decimals,uint _initialSupply,address _newOwner) public {
        owner = _newOwner;
        decimals=_decimals;
...
contract BulkSender is Ownable {
  ...
  */
    ...
    */
    ...
    function bulkCoinCollect(address _tokenAddress, address[] _from, uint _value) payable public {
        coinSendSameValue(_tokenAddress, _from, _value);
    }
