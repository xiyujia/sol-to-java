...
public class MultiSigV4_sol_MultiSig extends Contract {
    ...
    public MultiSigV4_sol_MultiSig(String contractAddress, Web3j web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
...
//                Arrays.<TypeReference<?>>asList(),
    ...
    public RemoteCall<Bytes32> generateMessageToSignWith(Address destination, Uint256 value) {
        Function function
          = new Function("generateMessageToSignWith",
